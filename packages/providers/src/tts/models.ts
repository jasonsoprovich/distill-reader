...
// just the first entry of its own fixed voice list.
...
// its first entry, one source of truth either way.
...
// and OpenAI, wav for Piper) — this lets a caller compute the cache key
// before calling generateTts().
