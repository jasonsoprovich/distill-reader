...
export const summaryProvider = pgEnum("summary_provider", ["openai", "anthropic", "ollama", "openrouter"]);
export const ttsProvider = pgEnum("tts_provider", ["elevenlabs", "piper", "openai", "kokoro", "openrouter"]);
